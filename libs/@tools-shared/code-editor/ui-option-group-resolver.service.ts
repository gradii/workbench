...
import { ComponentProperties, componentsProperties, OutputProperty, StoreItemType } from '@common/public-api';
...
export class UIOptionGroupResolverService {
  ...
  private createComponentOptions(component: PuffComponent): SelectorOption[] {
  ...
  private createComponentOption(component: PuffComponent, property: OutputProperty): SelectorOption {
    return {
