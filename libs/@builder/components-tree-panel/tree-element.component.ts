...
import { ComponentTreeNode, ComponentTreeNodeVisibility, SlotTreeNode } from './components-tree.model';
...
export class TreeElementComponent implements AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    fromEvent(this.ref.nativeElement, 'mouseenter')
      ...
      .subscribe(() => this.componentFacade.setHoveredComponent(this.component.kitchenComponent.id));
  }
  ...
  public get label(): string {
    if (this.component instanceof ComponentTreeNode) {
      const { fullName, kitchenComponent } = this.component;
      return (
        kitchenComponent.properties.name || fullName || this.componentSettingsService.splitName(
  ...
  public get iconName(): string {
    if (this.component instanceof ComponentTreeNode) {
      return this.componentSettingsService.getComponentIconName(
        this.component.kitchenComponent.definitionId,
        this.component.fullName,
        this._active
      );
    } else {
      return (this.component as SlotTreeNode).fullName;
    }
  }
