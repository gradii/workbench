  ...
  template: `
    <div class="data-source-container">
      <label class="data-source-main-label">
        <tri-icon class="data-consumer" svgIcon="workbench:database" pack="bakery"></tri-icon>
        Sequence Variable
      </label>
    </div>
    ...
    <input triInput fullWidth [formControl]="itemNameControl" [attr.disabled]="inputDisabled ? '' : null" />
    ...
    <input triInput fullWidth [formControl]="itemIndexControl" [attr.disabled]="inputDisabled ? '' : null" />
    <div *ngIf="!inputDisabled" class="validation-errors">
...
export class ForSettingFieldComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @Input('component') set _component(component: PuffComponent) {
