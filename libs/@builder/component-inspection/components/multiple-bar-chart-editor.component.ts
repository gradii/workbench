...
import { ComponentLogicPropName, multipleBarChartSample, SequenceProperty } from '@common/public-api';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector       : 'pf-multiple-bar-chart-editor',
        ...
        <tri-accordion pfAccordionController>
          ...
          <tri-accordion-item title="Content">
              ...
              <ub-data-source-settings-field
                ...
                [formatExample]="multipleBarChartData"
                (valueChange)="updateProperty.emit({ data: $event })"
                dataFormatType="Multiple Bar Chart"
              >
              </ub-data-source-settings-field>
...
export class MultipleBarChartEditorComponent implements SettingsView {
  @Input()
  ...
  multipleBarChartData: any = multipleBarChartSample;
