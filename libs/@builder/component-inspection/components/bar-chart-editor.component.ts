...
import { barChartSample, ComponentLogicPropName, SequenceProperty } from '@common/public-api';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector       : 'pf-bar-chart-editor',
        ...
        <tri-accordion pfAccordionController>
          ...
          <tri-accordion-item title="Content">
            <ub-data-source-settings-field
              ...
              [formatExample]="barChartData"
              (valueChange)="updateProperty.emit({ data: $event })"
              dataFormatType="Bar Chart"
            >
            </ub-data-source-settings-field>
          </tri-accordion-item>
...
export class BarChartEditorComponent implements SettingsView {
  ...
  barChartData: any = barChartSample;
