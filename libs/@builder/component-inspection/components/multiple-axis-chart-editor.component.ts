...
import { ComponentLogicPropName, multipleAxisChartSample, SequenceProperty } from '@common/public-api';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector       : 'pf-multiple-axis-chart-editor',
        ...
        <tri-accordion pfAccordionController>
          ...
          <tri-accordion-item title="Content">
              ...
              <ub-data-source-settings-field
                ...
                [formatExample]="multipleAxisData"
                (valueChange)="updateProperty.emit({ data: $event })"
                dataFormatType="Multiple Axis"
              >
              </ub-data-source-settings-field>
...
export class MultipleAxisChartEditorComponent implements SettingsView {
  @Input()
  ...
  multipleAxisData: any = multipleAxisChartSample;
