import { TriAclService } from '@gradii/triangle/auth';
import { Observable } from 'rxjs';
import { Injectable } from '@angular/core';
import { map } from 'rxjs/operators';
import { aclConfig, evaluatePrivileges, PlanConfig, plansConfig, RoleEvaluatorContext } from '@common/public-api';
...
export class PrivilegesEvaluator {
  ...
  constructor(private acl: TriAclService,
              private dataSource: PrivilegesEvaluatorDataSource) {
  }
