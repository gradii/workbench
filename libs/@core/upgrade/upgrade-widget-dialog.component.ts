...
@Component({
  selector: 'kitchen-upgrade-widget-dialog',
    ...
    <tri-card>
      ...
      <tri-card-body>
        ...
        <div class="component-list-margin-sm component-top-margin">
          <button triButton (click)="close()">No, thank you</button>
...
export class UpgradeWidgetDialogComponent {
  constructor(private dialogRef: TriDialogRef<UpgradeWidgetDialogComponent>) {
  }
