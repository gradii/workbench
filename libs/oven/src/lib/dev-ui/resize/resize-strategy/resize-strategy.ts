...
import { CommitResizeOvenSpace } from '@common';
...
export class ResizeStrategy implements OnDestroy {
  ...
  private commitResize = new Subject<CommitResizeOvenSpace>();
  public readonly commitResize$: Observable<CommitResizeOvenSpace> = this.commitResize.asObservable();
