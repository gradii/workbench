...
import { OvenComponent, SyncReasonMsg } from '@common';
import { Observable } from 'rxjs';

import { Slot } from './definition-utils';
import { OvenDataValidator } from '../workflow/data/data-validator.service';
...
export interface Definition {
  ...
  dataValidator?: OvenDataValidator;
  propsMapper?: ComponentPropsMapper;

  factory(bindings?: any): OvenComponent;

  inHeaderFactory?(bindings?: any): OvenComponent;

  inSidebarFactory?(bindings?: any): OvenComponent;
}
