...
export class PutInLocalStorageExecutorService implements StepExecutor {
  ...
  constructor(private kitchenState: KitchenState, private executorUtils: ExecutorUtilService) {
  }
  ...
  private updateLocalStorageItem(id: string, value: string) {
    ...
    this.kitchenState.emitMessage(StateAction.UPDATE_LOCAL_STORAGE_ITEM, { name: id, value });
  }
}
