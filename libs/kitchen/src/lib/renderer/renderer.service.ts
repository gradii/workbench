...
export class RendererService {
  ...
  create<T>(component: KitchenComponent, slot: Slot, syncReason: SyncReasonMsg): View<T> {
  ...
  performBinding<T>(view: View<T>, component: KitchenComponent) {
    try {
  ...
  private executeBinding<T>(view: View<T>, component: KitchenComponent) {
  ...
  private createView<T>(slot: Slot, component: KitchenComponent, syncReason: SyncReasonMsg): View<T> {
  ...
  private fixTableRendering(view, component: KitchenComponent) {
  ...
  private scheduleTableRerendering(view, component: KitchenComponent) {
    if (component.definitionId === 'smartTable') {
  ...
  private hackDisabled(view) {
    if ('disabled' in view.instance) {
      view.instance.kitchenDisabled = view.instance.disabled;
   ...
   */
  private compileViewProps(styles: KitchenBreakpointStyles, component: KitchenComponent) {
  ...
  private resolveIndex(component: KitchenComponent, slot: Slot): number {
    /**
