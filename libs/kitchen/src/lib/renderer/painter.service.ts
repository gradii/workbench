...
import { KitchenApp, ShadedColor, Theme } from '@common/public-api';
...
export class PainterService {
  ...
  private getDevUIVarList(theme: Theme): { name: string; value: string }[] {
    ...
    const spaceSelectedBackgroundColor: string = theme.dark ? 'rgba(200,206,219,0.05)' : 'rgba(255,133,102,0.04)';
    return [
