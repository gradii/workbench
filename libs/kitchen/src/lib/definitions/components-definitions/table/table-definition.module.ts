...
export function tableFactory(): KitchenComponent {
  ...
  return {
    ...
    definitionId: 'table',
    slots: {
      header0: new KitchenSlot([spaceFactory([textFactory('Header 1', 'subtitle')], 'center', true, cellPaddings)]),
      header1: new KitchenSlot([spaceFactory([textFactory('Header 2', 'subtitle')], 'center', true, cellPaddings)]),
      cell00: new KitchenSlot([spaceFactory([], 'center', true, cellPaddings)]),
      cell01: new KitchenSlot([spaceFactory([], 'center', true, cellPaddings)]),
      cell10: new KitchenSlot([spaceFactory([], 'center', true, cellPaddings)]),
      cell11: new KitchenSlot([spaceFactory([], 'center', true, cellPaddings)])
    },
    styles: {
