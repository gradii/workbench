...
@Directive({ selector: '[kitchenWithThemeVariable]' })
export class KitchenWithThemeVariableDirective {
  @Input() set kitchenWithThemeVariable(themeVariables: { [varName: string]: string }) {
