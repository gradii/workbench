...
export function findParentComponent(
  el: HTMLElement,
  projectComponents: Map<HTMLElement, FlourComponent | FlourComponent>,
...
export function findNearestComponent(
  ...
  const siblingComponents: FlourComponent[] = [];
  ...
  const siblingsPeakPoints: CompPeakPoints[] = siblingComponents.map((vc: FlourComponent) => {
