...
export class DropPositionCalculator {
  create(
    el: HTMLElement,
    e: MouseEvent,
    projectComponents: Map<HTMLElement, FlourComponent>,
    ...
    const targetComponent: FlourComponent = projectComponents.get(target);
  ...
  private createHighlightDropCommand(
    ...
    targetComponent: FlourComponent,
    target: HTMLElement,
    projectComponents: Map<HTMLElement, FlourComponent>
  ): HighlightDropPositionCommand {
  ...
  private resolveTarget(
    ...
    const position             = document.elementFromPoint(e.clientX,
      thumbRect.top - TARGET_SEARCH_OFFSET) as HTMLElement;
  ...
  private createDropInsideCommand(rect: ClientRect, e: MouseEvent, vc: FlourComponent): HighlightDropPositionCommand {
  ...
  private resolveIsColumn(vc: FlourComponent): boolean {
