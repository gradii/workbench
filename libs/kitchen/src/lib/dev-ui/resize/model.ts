...
export const VIRTUAL_COMPONENT = new InjectionToken<FlourComponent>('Virtual Component');
export const ATTACHED_COMPONENTS$ = new InjectionToken<Observable<FlourComponent[]>>('Attached Components');
