...
import { MessageAction, KitchenPage } from '@common/public-api';
 ...
 * That's why when we're doing navigation in kitchen, using menu or links or whatever in preview mode
...
export class RouterFeedbackService {
  constructor(private router: Router, private state: KitchenState) {
  }
  ...
  handleRouting(): void {
    ...
    navigationEnd$
      ...
      .subscribe((page: KitchenPage) => this.sendPageSelectedMessage(page));
  }
  ...
  private sendPageSelectedMessage(page: KitchenPage): void {
