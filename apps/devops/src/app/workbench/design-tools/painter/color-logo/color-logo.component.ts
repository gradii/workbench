...
@Component({
  selector: 'len-color-logo',
  changeDetection: ChangeDetectionStrategy.OnPush,
  styleUrls: ['./color-logo.component.scss'],
  template: `
    <button triButton ghost class="basic upload-button" (click)="imageInput.click()">
    ...
    >
      <tri-icon *ngIf="!image" class="upload-icon" svgIcon="outline:download" (click)="imageInput.click()"></tri-icon>
