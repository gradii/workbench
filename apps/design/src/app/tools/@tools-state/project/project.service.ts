...
import { AppModelVersionService } from '@tools-state/app/app-model-version.service';
...
export class ProjectService {
  ...
  updateProjectModel(projectId: string, newState: BakeryApp): Observable<{ app: BakeryApp; version: number }> {
    return this.http
