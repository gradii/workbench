...
import { Workflow, WorkflowLog, WorkflowLogExtended, WorkflowLogLevel } from '@common';
import { BehaviorSubject, combineLatest, Observable, Subject } from 'rxjs';
import { map, shareReplay, takeUntil } from 'rxjs/operators';

import { CommunicationService } from '@shared/communication/communication.service';
import { WorkflowFacade } from '@tools-state/data/workflow/workflow-facade.service';
import { stepInfo } from '../../../workflow/workflow-settings/workflow-info.model';
import { WorkflowUtilsService } from './workflow-utils.service';

@Injectable({ providedIn: 'root' })
export class WorkflowLoggerService implements OnDestroy {
