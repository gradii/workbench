...
import { StoreItem, StoreItemType, Workflow } from '@common';
...
@Component({
  selector: 'ub-state-manager-list',
...
export class StateManagerListComponent implements OnDestroy, OnInit {
  ...
  constructor(private storeItemUtils: StoreItemUtilService, private cd: ChangeDetectorRef) {
  }
