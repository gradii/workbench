...
import { nextId, StepType, Workflow, WorkflowStep, WorkflowStepParameter } from '@common';
...
@Component({
  ...
  template: `
    ...
    <nb-tabset *ngIf="activeStep?.type !== 'draft'" class="tabs">
      <nb-tab tabTitle="Setup" tabId="step-setup">
        <ub-step-settings
      ...
      <nb-tab [tabTitle]="errorsTabTitle$ | async" tabId="step-errors">
...
export class StepPropertiesComponent {
  ...
  @Input('activeStepId') set activeStepIdSetter(value: string) {
