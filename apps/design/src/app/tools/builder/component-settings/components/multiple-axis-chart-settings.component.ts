...
import { ComponentLogicPropName, multipleAxisChartSample, SequenceProperty } from '@common';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector: 'ub-multiple-axis-chart-settings',
...
export class MultipleAxisChartSettingsComponent implements SettingsView {
  @Input()
