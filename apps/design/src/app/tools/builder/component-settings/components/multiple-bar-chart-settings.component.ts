...
import { ComponentLogicPropName, multipleBarChartSample, SequenceProperty } from '@common';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector: 'ub-multiple-bar-chart-settings',
...
export class MultipleBarChartSettingsComponent implements SettingsView {
  @Input()
