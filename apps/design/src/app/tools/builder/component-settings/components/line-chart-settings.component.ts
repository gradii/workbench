...
import { ComponentLogicPropName, lineChartSample, SequenceProperty } from '@common';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector: 'ub-line-chart-settings',
          ...
          <nb-accordion-item expanded>
            ...
            <nb-accordion-item-body>
              <ub-data-source-settings-field
                ...
                [formatExample]="lineChartData"
                (valueChange)="updateProperty.emit({ data: $event })"
                dataFormatType="Line Chart"
              >
              </ub-data-source-settings-field>
            </nb-accordion-item-body>
          </nb-accordion-item>
...
export class LineChartSettingsComponent implements SettingsView {
  @Input()
  ...
  lineChartData: any = lineChartSample;
