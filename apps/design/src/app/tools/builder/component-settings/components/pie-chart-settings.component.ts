...
import { ComponentLogicPropName, pieChartSample, SequenceProperty } from '@common';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector: 'ub-pie-chart-settings',
          ...
          <nb-accordion-item expanded>
            ...
            <nb-accordion-item-body>
              <ub-data-source-settings-field
                ...
                [formatExample]="pieChartData"
                (valueChange)="updateProperty.emit({ data: $event })"
                dataFormatType="Pie Chart"
              >
              </ub-data-source-settings-field>
            </nb-accordion-item-body>
          </nb-accordion-item>
...
export class PieChartSettingsComponent implements SettingsView {
  @Input()
  ...
  pieChartData: any = pieChartSample;
