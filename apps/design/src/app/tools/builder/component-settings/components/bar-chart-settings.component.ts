...
import { barChartSample, ComponentLogicPropName, SequenceProperty } from '@common';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector: 'ub-bar-chart-settings',
...
export class BarChartSettingsComponent implements SettingsView {
