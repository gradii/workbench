...
import { bubbleMapSample, ComponentLogicPropName, SequenceProperty } from '@common';

import { ComponentSettings, SettingsView } from '../settings-view';

@Component({
  selector: 'ub-bubble-map-settings',
...
export class BubbleMapSettingsComponent implements SettingsView {
