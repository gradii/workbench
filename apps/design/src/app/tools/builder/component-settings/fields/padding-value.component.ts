...
import { PaddingUnit, PaddingValue } from '@common';
...
export class PaddingValueComponent extends InputWithUnit<PaddingValue, PaddingUnit>
  ...
  @ViewChild(NbPopoverDirective) popoverDirective: NbPopoverDirective;
  @ViewChild(NbPopoverDirective, { read: ElementRef }) popoverElementRef: ElementRef<HTMLInputElement>;
