...
export enum ErrorCodes {
  ...
  HA_ERR_ROW_NOT_VISIBLE = 187,
  HA_ERR_ABORTED_BY_USER = 188,
  HA_ERR_DISK_FULL = 189,
  HA_ERR_INCOMPATIBLE_DEFINITION = 190,
  HA_ERR_FTS_TOO_MANY_WORDS_IN_PHRASE = 191,
  HA_ERR_DECRYPTION_FAILED = 192,
  HA_ERR_FK_DEPTH_EXCEEDED = 193,
  HA_ERR_TABLESPACE_MISSING = 194,
  HA_ERR_SEQUENCE_INVALID_DATA = 195,
  HA_ERR_SEQUENCE_RUN_OUT = 196,
  ER_HASHCHK = 1000,
  ER_NISAMCHK = 1001,
  ER_NO = 1002,
  ER_YES = 1003,
