import { CommonBinary } from './common-binary-cmd';
import { Errors } from '../misc/errors';
import { Parse } from '../misc/parse';
import { BulkPacket } from '../io/bulk-packet';

/**
 * Protocol COM_STMT_BULK_EXECUTE
 * @see https://mariadb.com/kb/en/library/com_stmt_bulk_execute/
 */
export class BatchBulk extends CommonBinary {
  onPacketReceive;
