...
import { FieldDetail } from '../const/field-detail';
...
export class CommonText extends ResultSet {
...
export function getDatePartQuote(year, mon, day, hour, min, sec, ms) {
...
export function getLocalDate(date, opts) {
...
export function getUtcDate(date, opts) {
...
export function getTimezoneDate(date, opts) {
