...
import SslRequest from './ssl-request';
import ClientHandshakeResponse from './client-handshake-response';
import InitialHandshake from './initial-handshake';
...
export class Handshake extends Command {
  ...
  parseHandshakeInit(packet, out, opts, info) {
    ...
    const handshake = new InitialHandshake(packet, info);
