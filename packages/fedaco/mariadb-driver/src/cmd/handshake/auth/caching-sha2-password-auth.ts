...
import { createError, Errors } from '../../../misc/errors';
import { NativePasswordAuth } from './native-password-auth';
import { Sha256PasswordAuth } from './sha256-password-auth';
 ...
 */
export class CachingSha2PasswordAuth extends PluginAuth {
  pluginData;
  sequenceNo;
  counter;
  state;
  ...
  response(packet, out, opts, info) {
    ...
    switch (marker) {
      ...
      default:
        const promptData = packet.readBufferRemaining();
